     ...
     <ul class="sidebar-menu" data-widget="tree">
       ...
       <li class="treeview">
         ...
         <ul class="treeview-menu">
           ...
           <li><a href="<?php echo base_url('lokasi') ?>"><i class="fa fa-circle-o"></i>Lokasi</a></li>
           <li><a href="<?php echo base_url('lokasi_foto') ?>"><i class="fa fa-circle-o"></i>Lokasi Foto</a></li>
           <li><a href="<?php echo base_url('lokasijadwalhari') ?>"><i class="fa fa-circle-o"></i>Lokasi Jadwal Hari</a></li>
           <li><a href="<?php echo base_url('lokasijadwaljam') ?>"><i class="fa fa-circle-o"></i>Lokasi Jadwal Jam</a></li>
           <li><a href="<?php echo base_url('lokasitiket') ?>"><i class="fa fa-circle-o"></i>Lokasi Tiket</a></li>
         </ul>
       </li>
       <li class="treeview">
         <a href="#">

        ...
        <div class="sidebar-navigation hidde-sm hidden-xs">
            ...
            <ul class="social-icons">
                <li><a href="<?php echo base_url('dashboard') ?>"><i class="fa fa-facebook"></i></a></li>
                    ...
                    <div class="owl-carousel owl-theme">
                        <div class="item">
							...
							<?php foreach ($result as $key ) {
								?>
                                    <img src="<?php echo base_url('upload/lokasi/'.$key->foto) ?>" alt="">
                                </div>
                ...
                <div class="section-content">
                    <div class="masonry">
						...
						<?php
                            ...
                            <div class="item">
                                <div class="col-md-8">
                                    <a href="" data-lightbox="image"><img src="<?php echo base_url('upload/lokasi/'.$key->foto) ?>" alt="image 1"></a>
                                </div>
                            </div>
                            <!-- <div class="item second-item">
                                <div class="col-md-4">
                                    <a href="" data-lightbox="image"><img src="<?php echo base_url('upload/lokasi/'.$key->foto) ?>" alt="image 2"></a>
                                </div>
                            </div>
                            <div class="item">
                                <div class="col-md-4">
                                    <a href="" data-lightbox="image"><img src="<?php echo base_url('upload/lokasi/'.$key->foto) ?>" alt="image 3"></a>
                                </div>
                            </div>
                            <div class="item">
                                <div class="col-md-4">
                                    <a href="" data-lightbox="image"><img src="<?php echo base_url('upload/lokasi/'.$key->foto) ?>"" alt="image 4"></a>
                                </div>
                            </div>
                            <div class="item">
                                <div class="col-md-8">
                                    <a href="" data-lightbox="image"><img src="<?php echo base_url('upload/lokasi/'.$key->foto) ?>" alt="image 5"></a>
                                </div>
                            </div> -->
                        </div>
						<?php
